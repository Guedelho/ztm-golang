...
func (b *BandwidthUsage) AvarageBandwidth() int {
	sum := 0
...
func (c *CpuTemp) AvarageCpuTemp() int {
	sum := 0
...
func main() {
	...
	fmt.Println(dashboard.AvarageBandwidth())
	fmt.Println(dashboard.AvarageCpuTemp())
	fmt.Println(dashboard.AvarageMemoryUsage())
}
